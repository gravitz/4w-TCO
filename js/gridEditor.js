...
{ 
	this.editableGrid = new EditableGrid("Activity", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("../includes/loaddata.php?db_tablename=Activity");
};
...
// render for the action column
	grid.setCellRenderer("action", new CellRenderer({ 
		render: function(cell, id) {                 
			  ...
			  cell.innerHTML+= "<span onclick=\"datagrid.deleteRow("+id+");\" class=\"glyphicon glyphicon-trash\"></span>";
